defmodule LeagueManager.ScheduleService do
  ...
  defp schedule_games(pinned_team, teams, round, max_round, offset \\ 0, away_first \\ false)
  defp schedule_games(_, _, round, max_round,_ , _) when round > max_round, do: nil
  defp schedule_games(pinned_team, teams, round, max_round, offset, away_first) do
    [tribute | pool] = teams
    ...
    schedule_games(pinned_team, pool ++ [tribute], round + 1, max_round, offset, away_first)
  end
